---
layout: blog
title: Custom UI for Amplify and Next.js website with React Hook Form, Next.js, Tailwind CSS
timestamp: 1615884349829
snippet: Replacing the AWS Amplify hosted UI with a custom solution
