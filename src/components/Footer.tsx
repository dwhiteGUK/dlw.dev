...
import { Github, Strava, Twitter } from '~/components';

const Footer: FC = () => (
  <div>
    <div className="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
      <p className="text-center text-base leading-6 font-semibold uppercase text-gray-600 tracking-wider">Find me on</p>
